...
It's not correlating with practical experiments (they've not solved practical loopholes yet), but at least shows that it's logically possible to set up an ideal experiment which sometimes violate SHCH with local reality assumption and without any communication between participants or particles.
